...
/* harmony import */ var _components_aos__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/aos */ "./source/js/components/aos.js");
/* harmony import */ var _components_counter_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/counter.js */ "./source/js/components/counter.js");
...
/* harmony import */ var _components_inputMask_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/inputMask.js */ "./source/js/components/inputMask.js");
/* harmony import */ var _components_form__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/form */ "./source/js/components/form.js");
...
if (asideMenu) {
  ...
  function asideHandler(asideMenu, btn, wrapp) {
    btn.addEventListener('click', function (e) {
      e.preventDefault();
      (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_3__.toggleCustomClass)(asideMenu, 'active');
      (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_3__.toggleCustomClass)(btn, 'active');
      (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_3__.toggleCustomClass)(wrapp, 'active');
  ...
  function closeAsideHandler(asideMenu, btn, wrapp) {
    (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_3__.removeCustomClass)(asideMenu, 'active');
    (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_3__.removeCustomClass)(btn, 'active');
    (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_3__.removeCustomClass)(wrapp, 'active');
  }
...
if (cookies) {
  setTimeout(function () {
    (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_3__.addCustomClass)(cookies, 'active');
  }, 5000);
}
...
if (menuForm) {
  const validator = new just_validate__WEBPACK_IMPORTED_MODULE_0__["default"]('#menuForm');
  validator.addField('input[type="tel"]', [{
    rule: 'required',
    errorMessage: 'This field is required!'
  }]);
...
if (orderForm) {
  const validator = new just_validate__WEBPACK_IMPORTED_MODULE_0__["default"]('#orderForm');
  validator.addField('input[type="tel"]', [{
    rule: 'required',
    errorMessage: 'This field is required!'
  }]);
...
let im = new (_vendor_inputMask_js__WEBPACK_IMPORTED_MODULE_0___default())('+38 (999) 999-99-99');
im.mask(selector);
...
function buttonClickHandler(e, buttonAttribute, activeClass) {
  ...
  burger && (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_3__.removeCustomClass)(burger, activeClass);
  (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_3__.removeClassInArray)(modals, activeClass);
...
if (social) {
  window.addEventListener("resize", () => {
    (0,_functions_throttle__WEBPACK_IMPORTED_MODULE_1__.throttle)(replaceElementsFunction(social, socialParent, socialParentMob, 768, "beforeend", "beforeend"));
  });
  window.addEventListener("DOMContentLoaded", () => {
    (0,_functions_throttle__WEBPACK_IMPORTED_MODULE_1__.throttle)(replaceElementsFunction(social, socialParent, socialParentMob, 768, "beforeend", "beforeend"));
  });
...
if (faqAcc && faqAccParent) {
  window.addEventListener("resize", () => {
    (0,_functions_throttle__WEBPACK_IMPORTED_MODULE_1__.throttle)(replaceElementsFunction(faqAcc, faqAccParent, faqAccParentMob, 768, "afterbegin", "beforeend"));
  });
  window.addEventListener("DOMContentLoaded", () => {
    (0,_functions_throttle__WEBPACK_IMPORTED_MODULE_1__.throttle)(replaceElementsFunction(faqAcc, faqAccParent, faqAccParentMob, 768, "afterbegin", "beforeend"));
  });
