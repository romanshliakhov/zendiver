...
const mobileMenuHandler = function (mobileMenu, burger, bodyEl) {
  burger.forEach(btn => {
    btn.addEventListener('click', function (e) {
      ...
      (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_3__.toggleClassInArray)(burger);
      (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_3__.toggleCustomClass)(bodyEl);
      btn.classList.contains('active') ? (0,_functions_disable_scroll__WEBPACK_IMPORTED_MODULE_0__.disableScroll)() : (0,_functions_enable_scroll__WEBPACK_IMPORTED_MODULE_1__.enableScroll)();
    });
  });
};
const hideMenuHandler = function (mobileMenu, burger, bodyEl) {
  ...
  (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_3__.removeClassInArray)(burger);
...
if (relatedSlider) {
  (function () {
    ...
    const enableSwiper = function () {
      slider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](relatedSlider, {
        modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Autoplay, swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Grid],
        observer: true,
        observeParents: true,
        navigation: {
          nextEl: ".slide-next",
